...
exports.logout = exports.deleteAddress = exports.addAddress = exports.changePassword = exports.updateProfile = exports.getMe = exports.login = exports.register = void 0;
...
const updateProfile = async (req, res) => {
    try {
        ...
        const user = await User_1.default.findByIdAndUpdate(req.user?._id, { name, phone }, { new: true, runValidators: true });
        if (!user) {
            res.status(404).json({
                success: false,
                message: 'User not found'
